...
Kernels generated by the [D-ND_LAB](https://github.com/GrazianoGuiducci/D-ND_LAB) SSP pipeline (Scoperte → Soluzioni → Prodotti). Each package ships as a Python distribution with verification data from the cycle that produced it.
